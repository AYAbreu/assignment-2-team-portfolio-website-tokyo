<?php $currentTitle = 'CONLEY'; include'inc/html-top.inc';?>
    <header>
  <?php include'inc/nav.inc';?>
</header>
  
  <div class=headerbox>    
      <header><title>Women In CS - Conley</title></header>
    <header>
      <h1>Conley Ernest</h1>
    </header>
  </div>
